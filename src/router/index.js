...
export const constantRoutes = [{
    ...
    },
    {
        ...
        children: [{
            ...
            name: 'master',
            meta: { title: '管理员', icon: 'people', noCache: true }
        }]
    },
    {
        path: '/guide',
    ...
    },
    {
        ...
        children: [{
                ...
                name: 'Documentation',
                meta: { title: '公司主管理员', icon: 'documentation' }
            },
            {
                path: 'page',
                hidden: true,
                component: () =>
                    import ('@/views/documentation/page'),
                name: 'Documentation2',
                meta: { title: '菜单列表', icon: 'documentation', noCache: true }
            }
        ]
    },
    {
...
export const asyncRoutes = [{
...

    {
        path: '/tab',
        component: Layout,
        meta: { title: '新页面', icon: 'tab' },
        children: [{
            path: 'index',
            component: () =>
                import ('@/views/tab/index'),
            name: 'Tab',
            meta: { title: '模块页面', icon: 'tab' }
        }, {
            path: 'page',
            hidden: true,
            component: () =>
                import ('@/views/tab/page'),
            name: 'Tab2',
            meta: { title: '新页面2', icon: 'tab' }
        }]
    },
